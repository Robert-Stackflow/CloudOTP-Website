...
export const metadata: Metadata = {
  title: "Privacy Policy - CloudOTP",
  description:
    "CloudOTP privacy policy - We collect nothing. Zero tracking, zero analytics. Your data stays on your server.",
};
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-20">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto leading-relaxed">
                Your privacy isn't a feature—it's our foundation. CloudOTP is
                built to keep your data completely private and under your
                control.
              </p>
            </div>
              ...
              <div className="bg-gradient-to-br from-teal-50 via-cyan-50 to-blue-50 dark:from-teal-950 dark:via-cyan-950 dark:to-blue-950 border border-teal-200 dark:border-teal-800 rounded-3xl p-12 shadow-lg">
                <div className="text-center">
                  ...
                  <p className="text-lg text-teal-700 dark:text-teal-300 leading-relaxed">
                    ...
                    Nothing. Your data is yours, and yours alone.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  ...
                  {
                    item: "Usage Data",
                    detail: "No tracking of how you use CloudOTP",
                  },
                  {
                    item: "Your Content",
                    detail: "Your tokens never touch our servers",
                  },
                  {
                    item: "Technical Data",
            ...
            <section className="mb-20">
              <div className="flex items-center justify-center gap-4 mb-12">
                ...
                <h2 className="text-3xl font-bold tracking-tight">
                  Secure & Cross-Platform by Design
                </h2>
              </div>
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-3xl p-12 shadow-lg mb-8">
                <p className="text-xl text-gray-700 dark:text-gray-300 text-center leading-relaxed mb-8">
                  CloudOTP is built to be{" "}
                  <strong>secure, fast, and cross-platform</strong>. Your 2FA
                  codes stay safe on your devices, and optional cloud backup
                  keeps them synced across platforms.
                </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "Available on Android, Windows, and Linux — one consistent experience everywhere.",
                    },
                    {
                      title: "Privacy First",
                      description:
                        "Your OTP secrets are encrypted and stored locally. Only you can access them.",
                    },
                    {
                      title: "Cloud Backup Optional",
                      description:
                        "Backup and sync your codes securely in the cloud, or keep them fully offline — your choice.",
                    },
                  ].map((step, index) => (
                ...
                {[
                  {
                    title: "Offline-First",
                    description:
                      "CloudOTP works fully offline — no external servers needed unless you choose cloud backup.",
                  },
                  {
                    title: "Complete Ownership",
                    description:
                      "You control your 2FA codes entirely. Your data is encrypted and cannot be accessed by anyone else.",
                  },
                ].map((feature, index) => (
                  <div
                    key={index}
            ...
            <section className="mb-20">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-3xl p-12 shadow-lg">
                <p className="text-xl text-gray-700 dark:text-gray-300 mb-8 text-center leading-relaxed">
                  ...
                  <strong>verify it yourself</strong>. Our code is publicly
            ...
            <section className="mb-20">
              ...
              <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-3xl p-12 shadow-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <a
                    href="https://github.com/Robert-Stackflow/CloudOTP/issues"
                    target="_blank"
                    rel="noopener noreferrer"
            ...
            <section className="text-center">
              <div className="bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8">
                ...
                <p className="text-gray-500 dark:text-gray-500 text-sm mt-2">
                  This policy reflects our commitment to your privacy. View the
                  latest version on{" "}
                  <a
                    href="https://github.com/Robert-Stackflow/CloudOTP"
                    target="_blank"
